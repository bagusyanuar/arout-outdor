            ...
            <div class="col-lg-3 col-md-12">
                <div style="border: solid 1px #777777; border-radius: 5px; padding: 10px;">
                    ...
                    <div class="d-flex justify-content-between align-items-center w-100">
                        <div style="font-size: 14px; color: #777777" class="w-50">Sisa {{ $data->qty }}</div>
                        <div class="d-flex mb-2">
                            <a href="#" class="btn btn-sm btn-outline-primary mr-1"><i class="fa fa-minus"></i></a>
                            <input class="form-control form-control-sm text-right w-100" type="number" id="qty" name="qty"
                                   value="0">
